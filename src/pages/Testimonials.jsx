...
import React from 'react';
import '../../node_modules/swiper/swiper-bundle.min.css'; // Use this for version 10+
import { Swiper, SwiperSlide } from 'swiper/react';
        ...
        <div className="proj_h1 row mb-4">
          <div className="col-md-8">
            <div className="proj_h1l">
              ...
              <h2 className="fw-normal1 mb-0">OUR CUSTOMER <span className="fw-normal">WORDS</span></h2>
            </div>
          </div>
        </div>
        <Swiper
            ...
            <SwiperSlide key={index}>
              <div className="testim_1i shadow_box position-relative">
                <div className="testim_1i1 text-center pt-5 pb-5 px-4">
                  ...
                  <h6 className="text-muted mb-3">{testimonial.location}</h6>
                  <img
                    src={testimonial.avatar}
                    alt="avatar"
                    className="rounded-circle"
                  />
                  <p className="mt-3 mb-0">{testimonial.quote}</p>
                </div>
